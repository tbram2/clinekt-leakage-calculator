// Round 7 identity (2026-09-22): the Clinekt wordmark, Outfit 600 in ink, used by the injected nav/footer and swapped into the
// embed-built pages (home, FAQs) that ship the old lockup. File-level so every scope below can see it.
var BRAND_WM = 'https://cdn.jsdelivr.net/gh/tbram2/clinekt-leakage-calculator@57b4389/site-assets/media/brand/clinekt-wordmark-ink.svg';
